...
class DoubleHomePage extends StatefulWidget {
  @override
  _DoubleHomePageState createState() => _DoubleHomePageState();
}

class _DoubleHomePageState extends State<DoubleHomePage> {
